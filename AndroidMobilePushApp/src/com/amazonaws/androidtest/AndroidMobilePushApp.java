...
public class AndroidMobilePushApp extends Activity {
    ...
    String accessKey = "AKIAIW2LLL5G57AADUMA";
    String secretKey = "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";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CreateTopicRequest ctr = new CreateTopicRequest( "testing_new" );
        ...
        SubscribeRequest sr = new SubscribeRequest( result.getTopicArn(), "email", "sharathmk99@gmail.com" );
